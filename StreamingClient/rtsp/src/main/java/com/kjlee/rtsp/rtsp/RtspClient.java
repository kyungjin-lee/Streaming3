...
import com.kjlee.rtsp.utils.CreateSSLSocket;
      ...
      thread = new Thread(new Runnable() {
        ...
        public void run() {
          try {
            ...
            Log.d("KJLEE","output stream port: "+connectionSocket.getPort());
            writer = new BufferedWriter(new OutputStreamWriter(outputStream));
            commandsManager.createOptions();
            commandsManager.createAnnounce();
            commandsManager.createSetup(commandsManager.getTrackAudio());
            commandsManager.createSetup(commandsManager.getTrackVideo());
            /*
